...
export default function LifestyleGroomingFragranceNicheFragrances() {
  return (
    <Layout>
      <main className="max-w-[1800px] mx-auto px-6 py-24">
        <header className="mb-24 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-[#666] font-light leading-relaxed max-w-2xl">
            Beyond the mainstream. Artisanal perfumers and limited editions for the true connoisseur.
          </p>
        </header>
