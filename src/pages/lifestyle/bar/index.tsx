...
export default function LifestyleBar() {
  return (
    <Layout>
      <main className="max-w-[1800px] mx-auto px-6 py-24">
        <header className="mb-24 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-[#666] font-light leading-relaxed max-w-2xl">
            The gentleman's guide to fine spirits and barware. Curate your home bar with distinction.
          </p>
        </header>
        ...
        <section className="mt-16">
          <h2 className="text-3xl font-light mb-8 text-[#1A1A1A]">Explore Bar & Spirits</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-[#E5E5E0] border border-[#E5E5E0]">
          <Link href="/lifestyle/bar/whiskey" className="bg-[#F5F5F0] p-12 min-h-[300px] flex flex-col justify-between group hover:bg-[#F0F0EB] transition-colors">
            <span className="text-xs uppercase tracking-widest text-[#999]">01 — Explore</span>
            <h3 className="text-2xl font-light mt-4 mb-8">Whiskey</h3>
            <div className="w-full h-px bg-[#E5E5E0] group-hover:bg-[#D5D5D0] transition-colors" />
          </Link>
          <Link href="/lifestyle/bar/wine" className="bg-[#F5F5F0] p-12 min-h-[300px] flex flex-col justify-between group hover:bg-[#F0F0EB] transition-colors">
            <span className="text-xs uppercase tracking-widest text-[#999]">02 — Explore</span>
            <h3 className="text-2xl font-light mt-4 mb-8">Wine</h3>
            <div className="w-full h-px bg-[#E5E5E0] group-hover:bg-[#D5D5D0] transition-colors" />
          </Link>
          <Link href="/lifestyle/bar/cognac" className="bg-[#F5F5F0] p-12 min-h-[300px] flex flex-col justify-between group hover:bg-[#F0F0EB] transition-colors">
            <span className="text-xs uppercase tracking-widest text-[#999]">03 — Explore</span>
            <h3 className="text-2xl font-light mt-4 mb-8">Cognac</h3>
            <div className="w-full h-px bg-[#E5E5E0] group-hover:bg-[#D5D5D0] transition-colors" />
          </Link>
          <Link href="/lifestyle/bar/barware" className="bg-[#F5F5F0] p-12 min-h-[300px] flex flex-col justify-between group hover:bg-[#F0F0EB] transition-colors">
            <span className="text-xs uppercase tracking-widest text-[#999]">04 — Explore</span>
            <h3 className="text-2xl font-light mt-4 mb-8">Barware</h3>
            <div className="w-full h-px bg-[#E5E5E0] group-hover:bg-[#D5D5D0] transition-colors" />
          </Link>
          <Link href="/lifestyle/bar/glassware" className="bg-[#F5F5F0] p-12 min-h-[300px] flex flex-col justify-between group hover:bg-[#F0F0EB] transition-colors">
            <span className="text-xs uppercase tracking-widest text-[#999]">05 — Explore</span>
            <h3 className="text-2xl font-light mt-4 mb-8">Glassware</h3>
            <div className="w-full h-px bg-[#E5E5E0] group-hover:bg-[#D5D5D0] transition-colors" />
          </Link>
          <Link href="/lifestyle/bar/bar-accessories" className="bg-[#F5F5F0] p-12 min-h-[300px] flex flex-col justify-between group hover:bg-[#F0F0EB] transition-colors">
            <span className="text-xs uppercase tracking-widest text-[#999]">06 — Explore</span>
            <h3 className="text-2xl font-light mt-4 mb-8">Bar Accessories</h3>
            <div className="w-full h-px bg-[#E5E5E0] group-hover:bg-[#D5D5D0] transition-colors" />
          </Link>
          </div>
        </section>
