...
export default function LifestyleCigarsDominicanCigars() {
  return (
    <Layout>
      <main className="max-w-[1800px] mx-auto px-6 py-24">
        <header className="mb-24 max-w-4xl">
          <span className="text-xs uppercase tracking-widest text-[#999] mb-4 block">Cigars</span>
          ...
          <p className="text-xl md:text-2xl text-[#666] font-light leading-relaxed max-w-2xl">
            Smooth sophistication. Arturo Fuente, Davidoff, and Dominican craftsmanship.
          </p>
        </header>
